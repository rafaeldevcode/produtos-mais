...
@section('conteudo')
    ...
    <main class="container bg-white my-5 rounded p-3">
            ...
            <ul class="list-group">
                @foreach ($marcas as $marca)
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span>
                            <a href="/marca/{{ $marca->id }}/editar" class="btn btn-info">
        ...
        <section class="border-top border-success border-2 mt-5 d-flex flex-wrap justify-content-evenly justify-content-lg-between">
            ...
            <a href="/adicionar/produto" class="btn btn-primary mt-2 py-3 px-5 col-12 col-sm-7 col-md-5 col-lg-3">
                Novo Produto
                <i class="fas fa-plus-circle ms-2"></i>
            </a>

            <a href="/adicionar/comentario" class="btn btn-primary mt-2 py-3 px-5 col-12 col-sm-7 col-md-5 col-lg-3">
                Novo Comentário
                <i class="fas fa-plus-circle ms-2"></i>
            </a>
        </section>
