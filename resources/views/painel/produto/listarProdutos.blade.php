...
@section('conteudo')
    ...
    <main class="container bg-white my-5 rounded p-3">
        ...
        <div class="border-bottom border-success border-2 d-flex flex-column-reverse flex-md-row justify-content-md-between align-items-center">
            <h2>Produtos <span class="text-primary">{{ $nome_marca }}</span></h2>
        ...
        <section>
            <ul class="list-group mt-5">
                @if (empty($produtos[0]))
                    <li class="alert alert-danger text-center">Não exite nenhum produto cadastrado para essa marca!</li>
                @else
        ...
        <section class="border-top border-success border-2 mt-5 d-flex justify-content-between">
            <a title="Novo Produto" href="/adicionar/produto" class="btn btn-primary mt-2 py-3 px-5 col-12 col-sm-3">
                Novo Produto
    ...
    <script type="text/javascript">
        exibirFormularioExcluir('/produto', 'Certeza que deseja excluir o produto');
